...
namespace AdventOfCodeTests
{
    ...
    public class Day02Tests
    {
        ...
        public void LoadInput()
        {
            ...
            input_example1 = string.Format("forward 5{0}down 5{0}forward 8{0}up 3{0}down 8{0}forward 2", Environment.NewLine);
        ...
        public void Puzzle1()
        {
            ...
            // Assert
            Assert.AreEqual($"1561344", result);
        }
        ...
        {
            // Act
            var result = AdventOfCode.Day02.Puzzle2(input_example2);
